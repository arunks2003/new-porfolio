  ...
  technical: [
    {
      ...
      icon: FileCode,
      items: [
        { name: "C++", icon: TerminalSquare, proficiency: 4 },
        { name: "Java", icon: Cpu, proficiency: 4.5 },
        { name: "JavaScript", icon: SquareStack, proficiency: 5 },
        { name: "TypeScript", icon: Type, proficiency: 4.5 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "TailwindCSS", icon: Smartphone, proficiency: 5 },
        { name: "Material UI", icon: ScrollText, proficiency: 4 },
      ],
    },
    {
      category: "Databases",
    ...
    },
    {
      ...
      icon: Brain,
      items: [
        { name: "Data Structures", icon: SquareStack, proficiency: 4.5 },
        { name: "Algorithms", icon: GitFork, proficiency: 4 },
        { name: "Operating Systems", icon: Cpu, proficiency: 4 },
